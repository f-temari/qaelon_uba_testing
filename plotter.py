...
def makeFig():  # Create a function that makes our desired plot
    ...
    plt.ylim(-10, 10)  # Set limits of second y axis- adjust to readings you are getting
    plt2.plot(Raw, "b^-", label="Raw")  # plot pressure data
    plt2.set_ylabel("Raw")  # label second y axis
...
while True:  # While loop that loops forever
    ...
    P = float(dataArray[0]) # Convert first element to floating number and put in pressure
    R = float(dataArray[1]) # Convert second element to floating number and put in P
